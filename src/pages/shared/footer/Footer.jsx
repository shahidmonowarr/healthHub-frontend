...
const Footer = () => {
  return (
    <footer class="px-4 pt-10 pb-4 text-white bg-white border-t border-gray-200">
      <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
          <Link
            to="/"
            className="justify-start block text-left sm:text-center lg:text-left sm:justify-center lg:justify-start normal-case"
          >
            <div className="items-start sm:items-center justify-start block text-left sm:text-center lg:text-left sm:justify-center lg:justify-start normal-case">
              <img
                className="justify-start pt-8 w-6/6 overflow-hidden m-0"
          ...
          <div class="flex flex-col w-full text-gray-700">
            ...
            <div class="flex justify-start pl-4 mt-2">
              <a
                ...
                href="https://web.facebook.com/mdshahidmonowar"
              >
                <svg
                  viewBox="0 0 24 24"
      ...
      <div class="pt-4 mt-10 text-center text-gray-400 border-t border-gray-100">
        © 2023 HealthHub. All rights reserved.
      </div>
    </footer>
  );
};
